...
func TestGenerateProofResponse(t *testing.T) {
	...
	coordinatorAddress := common.HexToAddress("0x1234567890abcdef1234567890abcdef12345678")

	_, err := core.GenerateProofResponse(vrfkey, period, prevBeacon, chainId, coordinatorAddress, c.VRFConfig.KeyHash)
	if err != nil {
