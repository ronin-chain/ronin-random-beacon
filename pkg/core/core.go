...
func getProofSeed(period *big.Int, prevBeacon *big.Int, chainId *big.Int, verifyingContract common.Address, keyHash common.Hash) (*big.Int, error) {
...
func GenerateProofResponse(key vrfkey.KeyV2, period *big.Int, prevBeacon *big.Int, chainId *big.Int, verifyingContract common.Address, keyHash common.Hash) (*RandomWordsResponse, error) {
	// Generate a seed
	seed, err := getProofSeed(period, prevBeacon, chainId, verifyingContract, keyHash)
