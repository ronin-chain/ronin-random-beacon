...
// The ChainInfoFunc type is an adapter to allow the use of ordinary
// function as ChainInfo mutator.
type ChainInfoFunc func(context.Context, *db.ChainInfoMutation) (db.Value, error)

// Mutate calls f(ctx, m).
func (f ChainInfoFunc) Mutate(ctx context.Context, m db.Mutation) (db.Value, error) {
	if mv, ok := m.(*db.ChainInfoMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *db.ChainInfoMutation", m)
}

// The RandomRequestFunc type is an adapter to allow the use of ordinary
// function as RandomRequest mutator.
type RandomRequestFunc func(context.Context, *db.RandomRequestMutation) (db.Value, error)

// Mutate calls f(ctx, m).
func (f RandomRequestFunc) Mutate(ctx context.Context, m db.Mutation) (db.Value, error) {
	if mv, ok := m.(*db.RandomRequestMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *db.RandomRequestMutation", m)
}
