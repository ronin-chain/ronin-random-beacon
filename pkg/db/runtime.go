...
func init() {
	...
	// chaininfoDescFinalizedBlock is the schema descriptor for finalized_block field.
	chaininfoDescFinalizedBlock := chaininfoFields[2].Descriptor()
	// chaininfo.DefaultFinalizedBlock holds the default value on creation for the finalized_block field.
	chaininfo.DefaultFinalizedBlock = chaininfoDescFinalizedBlock.Default.(uint64)
