...
func (rrc *RandomRequestCreate) SetPreviousBeacon(u uint64) *RandomRequestCreate {
	rrc.mutation.SetPreviousBeacon(u)
	return rrc
}
...
func (rrc *RandomRequestCreate) check() error {
	...
	if _, ok := rrc.mutation.PreviousBeacon(); !ok {
		return &ValidationError{Name: "previousBeacon", err: errors.New(`db: missing required field "RandomRequest.previousBeacon"`)}
	}
...
func (rrc *RandomRequestCreate) createSpec() (*RandomRequest, *sqlgraph.CreateSpec) {
	...
	if value, ok := rrc.mutation.PreviousBeacon(); ok {
		_spec.SetField(randomrequest.FieldPreviousBeacon, field.TypeUint64, value)
		_node.PreviousBeacon = value
	}
...
func (u *RandomRequestUpsertOne) UpdateNewValues() *RandomRequestUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		...
		if _, exists := u.create.mutation.PreviousBeacon(); exists {
			s.SetIgnore(randomrequest.FieldPreviousBeacon)
		}
	}))
	return u
}
...
func (u *RandomRequestUpsertBulk) UpdateNewValues() *RandomRequestUpsertBulk {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		for _, b := range u.create.builders {
			...
			if _, exists := b.mutation.PreviousBeacon(); exists {
				s.SetIgnore(randomrequest.FieldPreviousBeacon)
			}
		}
	}))
