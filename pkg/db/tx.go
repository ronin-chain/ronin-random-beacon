...
func (tx *Tx) init() {
	tx.ChainInfo = NewChainInfoClient(tx.config)
	tx.RandomRequest = NewRandomRequestClient(tx.config)
...
// applies a query, for example: ChainInfo.QueryXXX(), the query will be executed
