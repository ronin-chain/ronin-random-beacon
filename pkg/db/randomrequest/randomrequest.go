...
const (
	...
	FieldPeriod = "period"
	// FieldPreviousBeacon holds the string denoting the previousbeacon field in the database.
	FieldPreviousBeacon = "previous_beacon"
...
// ByPreviousBeacon orders the results by the previousBeacon field.
func ByPreviousBeacon(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldPreviousBeacon, opts...).ToFunc()
}
